...
| RAFTInfer dev image | `raftinfer-dev:26.06-cuda13`; recorded final image ID `sha256:9e7ce1e85752d43a53cc2e8bf5c44f4ec610d43d38b28d922a4fab9701c6c340`; final user `rapids` | Project image assembled from listed dependencies | Target M0 CUDA build and smoke execution |
...
| `cmake` Rust crate | `0.1.58` from `registry+https://github.com/rust-lang/crates.io-index`, checksum `c0f78a02292a74a88ac736019ab962ece0bc380e3f977bf72e376c5d78ff0678` | MIT OR Apache-2.0 | `raftinfer-sys` build script invokes the native CMake build |
...
3. Functional and numerical correctness match the RAFTInfer kernel contract.
