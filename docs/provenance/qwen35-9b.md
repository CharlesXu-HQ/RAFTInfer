...
- requires a full 40-character model revision and matching local
  `.raftinfer-source-revision` evidence;
...
generic kernel was the dominant prefill cost. The RAFTInfer code remains native to
