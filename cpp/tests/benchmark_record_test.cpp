...
raftinfer::BenchmarkRecord complete_record() {
  return raftinfer::BenchmarkRecord{
...
int main() {
  const raftinfer::BenchmarkRecord record = complete_record();
  ...
  raftinfer::BenchmarkRecord imported = record;
  ...
  raftinfer::BenchmarkRecord fractional_timestamp = record;
  ...
  raftinfer::BenchmarkRecord local_offset_timestamp = record;
  ...
  raftinfer::BenchmarkRecord arbitrary_timestamp = record;
  ...
  raftinfer::BenchmarkRecord range_timestamp = record;
  ...
  raftinfer::BenchmarkRecord invalid_date_timestamp = record;
  ...
  raftinfer::BenchmarkRecord dot_without_fraction_timestamp = record;
  ...
  raftinfer::BenchmarkRecord native_with_revision = record;
  ...
  raftinfer::BenchmarkRecord imported_without_revision = record;
  ...
  raftinfer::BenchmarkRecord imported_empty_revision = record;
  ...
  raftinfer::BenchmarkRecord failed_correctness = record;
  ...
  raftinfer::BenchmarkRecord infinite_metric = record;
  ...
  raftinfer::BenchmarkRecord negative_metric = record;
  ...
  raftinfer::BenchmarkRecord invalid_cosine = record;
  ...
  raftinfer::BenchmarkRecord nan_timing = record;
  ...
  raftinfer::BenchmarkRecord negative_timing = record;
  ...
  raftinfer::BenchmarkRecord unordered_timing = record;
  ...
  raftinfer::BenchmarkRecord no_launches = record;
  ...
  raftinfer::BenchmarkRecord missing_identity = record;
